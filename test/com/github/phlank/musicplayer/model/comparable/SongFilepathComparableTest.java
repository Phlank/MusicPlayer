...
import com.github.phlank.musicplayer.model.comparable.SongFilepathComparable;
...
public class SongFilepathComparableTest {
	...
	public void testAfterSortIsSorted() {
		Collections.sort(songList, new SongFilepathComparable());
		boolean isSorted = true;
		for (int i = 0; i < 10 && isSorted; i++) {
			if (!songList.get(i).getFilepath().equals(String.valueOf(i))) {
				isSorted = false;
			}
		}
