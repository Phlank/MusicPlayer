...
public class SongTest {
	...
	@Test
	public void testSongNumberForWavUntagged() {
		Assert.assertEquals("", wavUntagged.getSongNumber());
	}

	@Test
	public void testSongDiskNumberForWavUntagged() {
		Assert.assertEquals("", wavUntagged.getSongDiskNumber());
	}

	@Test
	public void testSongYearForWavUntagged() {
		Assert.assertEquals("Unknown Year", wavUntagged.getSongYear());
	}
